<div class="row">
	<div class="col-md-8">
		<div class="card">
			<div class="card-body">
				<input name="title" type="text" class="form-control" placeholder="Judul Pos">
			</div>
		</div>
		...
		<div class="card">
			...
			<div class="collapse in" id="cat-collapse">
				...
				<div class="card-footer pb-3">
					<button class="btn btn-sm btn-info float-right mb-3 has-dropdown" data-toggle="modal" data-target="#addCategoryModal"><i class="fas fa-plus"></i> Tambah Kategori</button>
				</div>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="custom-file">
					<input type="file" class="custom-file-input" id="image-cover" accept="image/*">
